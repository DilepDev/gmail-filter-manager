...
class TestOAuthCredentialHandler(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.new_oauth_credential_file = './test_oauth_credential.json'
    ...
    def tearDown(self):
        if os.path.exists(self.new_oauth_credential_file):
            os.remove(self.new_oauth_credential_file)
        del self.oauth_credential_handler
        del self.new_oauth_credential_file

    def test_get_oauth_credential(self):
        self.assertIsInstance(self.oauth_credential_handler.get_oauth_credential(), Credentials)

    def test_is_valid(self):
        self.assertIsInstance(self.oauth_credential_handler.is_valid(), bool)

    def test_has_expired(self):
        self.assertIsInstance(self.oauth_credential_handler.has_expired(), bool)

    def test_write_oauth_credential_to_file(self):
        self.oauth_credential_handler.write_oauth_credential_to_file(self.new_oauth_credential_file)
